...
void main() {
    ...
    // if (uv.y > 0.0 && uv.y < offset || uv.y > 0.25 && uv.y < 0.25 + offset || uv.y > 0.5 && uv.y < 0.5 + offset || uv.y > 0.75 && uv.y < 0.75 + offset)
    if (uv.y < 0.25 && uv.y > 0.25 - offset || uv.y < 0.5 && uv.y > 0.5 - offset || uv.y < 0.75 && uv.y > 0.75 - offset || uv.y < 1.0 && uv.y > 1.0 - offset)
    {
