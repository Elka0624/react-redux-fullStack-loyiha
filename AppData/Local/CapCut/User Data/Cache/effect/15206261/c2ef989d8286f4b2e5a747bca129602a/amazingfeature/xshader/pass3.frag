...
vec4 blendColor(sampler2D sucai, vec4 baseColor,vec2 videoSize,vec2 sucaiSize,vec2 anchorImageCoord,float sucaiScale)
{
    ...
    lowp vec3 color = blendFunc(baseColor.rgb, clamp(fgColor.rgb * (1.0 / fgColor.a), 0.0, 1.0), 1.0,blendMode);
...
void main(void) 
{
    ...
    //8735383269835388128-170693612698071687191568886727481148814187268220444053676-3862209610545766337
    ...
    lowp vec4 fullblendColor = blendColor(_MainTex,baseColor,baseTexureSize,fullBlendTexSize,
