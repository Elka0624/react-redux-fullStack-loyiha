...
function Transform.new(construct, ...)
    ...
    self.duration = 0
    -- 设置起始点
    self.startPoint = Amaz.Vector3f(-1.3, 0.0, 0.0)
    -- 设置起始点旋转方向
    self.startRotate = Amaz.Vector3f(0.0, 0.0, -10.0)
    -- 设置起始点缩放系数
    self.startScale = Amaz.Vector3f(1.1, 1.1, 1.0)
    -- 设置结束点
    ...
    -- 设置模糊强度
    self.blurIntensity = 7.0
    -- 设置模糊的方向
    self.blurDirection = Amaz.Vector2f(1.0, 0);
